...
@hydra.main(config_path="../config", config_name="base_distill", version_base=None)
def main(cfg: DictConfig):
    ...
    ema_scale_fn = create_ema_and_scales_fn(
        target_ema_mode=cfg.training.target_ema_mode,
        start_ema=cfg.training.start_ema,
        scale_mode=cfg.training.scale_mode,
        start_scales=cfg.training.start_scales,
        end_scales=cfg.training.end_scales,
        total_steps=cfg.training.total_training_steps,
        distill_steps_per_iter=cfg.training.distill_steps_per_iter,
    )
